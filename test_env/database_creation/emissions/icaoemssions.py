...
def calculate(z):
    ...
    emissions_df = pd.read_excel(r'database_creation\rawdata\emissions\edb-emissions-databank_v29 (web).xlsx', sheet_name='Gaseous Emissions and Smoke')
    ...
    yearly_emissions.to_excel(r'database_creation\rawdata\emissions\icao_cruise_emissions.xlsx')
