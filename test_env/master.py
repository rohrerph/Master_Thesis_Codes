import test_env.database_creation.tools.atmospheric_conditions
import test_env.database_creation.operational.airtimeefficiency
import test_env.database_creation.overall.overallefficiency
import database_creation.emissions.icaoemssions
import database_creation.emissions.to_vs_cruise_sfc
import test_env.database_creation.overall.aircraft_engine_configurations
...
import test_env.database_creation.structural.structuralefficiency
import test_env.database_creation.operational.seats
import test_env.database_creation.operational.seatloadfactor
...
import test_env.database_creation.overall.aggregate_per_aircraft
...
test_env.database_creation.operational.airtimeefficiency.calculate(flight_vel, savefig, folder_path)
print(' --> [CREATE AIRCRAFT DATABASE]: Load Demand Data from the US DOT...')
test_env.database_creation.overall.overallefficiency.calculate(savefig, km, heatingvalue_gallon, folder_path)
...
limit_tsfc = test_env.database_creation.overall.aircraft_engine_configurations.calculate(heatingvalue_kg, air_density, flight_vel, savefig, folder_path)
...
test_env.database_creation.operational.seats.calculate()
print(' --> [CREATE AIRCRAFT DATABASE]: Calculate Structural Efficiency...')
test_env.database_creation.structural.structuralefficiency.calculate(savefig, folder_path)
print(' --> [CREATE ANNUAL VALUES]: Calculate Seat Load Factor and Airborne Efficiency ...')
test_env.database_creation.operational.seatloadfactor.calculate(savefig, folder_path)
